...
const panelsData = [
  {
    ...
    audios: [
      { title: '1. El agua como fuente de vida', artist: 'Dra. Rossana Bulnes, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/intro1.mp3' },
      { title: '2. Importancia de las cuencas hidrográficas', artist: 'M.Sc Naomi Sandoval, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/intro2.mp3' },
      { title: '3. Contaminación del agua', artist: 'Lic. Ricardo García, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/intro3.mp3' },
      { title: '4. Escasez del agua dulce', artist: 'M.Sc Marcos Hernández, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/intro4.mp3' },
      { title: '5. Crisis hídrica', artist: 'M.Sc Vivian Estrada, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/intro5.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'I1. Historia del uso humano del agua', artist: 'Ing. Sebastián Charchalac, PhD. Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo1_1.mp3' },
      { title: 'I2. El ciclo del agua', artist: 'M.Sc Alicia García, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo1_2.mp3' },
      { title: 'I3. Factores que afectan el ciclo del agua', artist: 'M.Sc Mario Randolfo Moreno, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo1_3.mp3' },
      { title: 'I4. Impacto del ciclo del agua en el ambiente', artist: 'M.Sc Mario Randolfo Moreno, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo1_4.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'II1. Agua, salud e higiene desde una perspectiva de género', artist: 'Licda. Catalina Esquivel, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo2_1.mp3' },
      { title: 'II2. El papel de las mujeres en la gestión del agua', artist: 'Licda. Catalina Esquivel, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo2_2.mp3' },
      { title: 'II3. Experiencias de mujeres en gestión comunitaria del agua', artist: 'Licda. Catalina Esquivel, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo2_3.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'III1. Calidad del agua: parámetros físicos, químicos y biológicos', artist: 'Thalía Turrén Cruz, PhD. Tecnológico de Monterrey, México', url: '/audios/modulo3_1.mp3' },
      { title: 'III2a. Servicios de suministros de agua y saneamiento', artist: 'Thalía Turrén Cruz, PhD. Tecnológico de Monterrey, México', url: '/audios/modulo3_2a.mp3' },
      { title: 'III2b. Servicios de suministros de agua y saneamient.', artist: 'Thalía Turrén Cruz, PhD. Tecnológico de Monterrey, México', url: '/audios/modulo3_2b.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'IV1. Perspectiva global', artist: 'Dra. Rossana Bulnes, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/modulo4_1.mp3' },
      { title: 'IV2. Perspectiva local', artist: 'Lic. Ricardo García, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/modulo4_2.mp3' },
      { title: 'IV3. Dimensiones ambientales del recurso hídrico', artist: 'M.Sc Marcos Hernández, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/modulo4_3.mp3' },
      { title: 'IV4. Optimización del consumo doméstico de agua', artist: 'M.Sc David Cáceres, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/modulo4_4.mp3' },
      { title: 'IV5. Gestión de la calidad del agua y ecosistemas asociados', artist: 'M.Sc Naomi Sandoval, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/modulo4_5.mp3' },
      { title: 'IV6. Gestión del agua en el ámbito industrial', artist: 'M.Sc Vivian Estrada, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/modulo4_6.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'V2. Cambio climático y gestión del agua', artist: 'MEng. María Fernanda Rivas, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo5_2.mp4' },
      { title: 'V5. Medidas para afrontar los riesgos hídricos', artist: 'MEng. María Fernanda Rivas, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo5_5.mp4' },
      { title: 'V6a. Impacto en Centroamérica', artist: 'MEng. María Fernanda Rivas, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo5_6a.mp4' },
      { title: 'V6b. Impacto en Centroamérica', artist: 'MEng. María Fernanda Rivas, Centro Universitario de Occidente, Universidad de San Carlos, Guatemala', url: '/audios/modulo5_6b.mp4' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'VII1. El agua como derecho humano', artist: 'Jeremy Garro, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo7_1.mp3' },
      { title: 'VII2. Normativa en materia de aguas', artist: 'Jeremy Garro, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo7_2.mp3' },
      { title: 'VII3. Gobernanza del agua: enfoques y desafíos', artist: 'Jeremy Garro, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo7_3.mp3' },
      { title: 'VII4. Administración pública del agua', artist: 'Jeremy Garro, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo7_4.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'VIII1. Resolución de conflictos relacionados con el agua', artist: 'Mag. Allison Quesada, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo8_1.mp3' },
      { title: 'VIII2. Gestión de proyectos hídricos', artist: 'Mag. Allison Quesada, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo8_2.mp3' },
      { title: 'VIII3. Financiación y fondeo de servicios de agua', artist: 'Mag. Allison Quesada, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo8_3.mp3' },
      { title: 'VIII4. Valoración de inversiones y financiación en infraestructura hidráulica', artist: 'Mag. Allison Quesada, Escuela de Administración pública, Universiddad de Costa Rica', url: '/audios/modulo8_4.mp3' },
    ],
  ...
  },
  {
    ...
    audios: [
      { title: 'C1. Importancia del conocimiento, investigación y desarrollo de capacidades', artist: 'M.Sc David Cáceres, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/cierre1.mp3' },
      { title: 'C2. Implementación de acciones de gestión inteligente del agua en empresas y organismos gubernamentales', artist: 'M.Sc Naomi Sandoval, Universidad Pedagógica Nacional Francisco Morazán, Honduras', url: '/audios/cierre2.mp3' },
    ],
