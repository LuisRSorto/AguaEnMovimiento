...
const panelsData = [
  {
    title: 'INTRODUCCIÓN',
    description: 'El agua que nos une tiene muchas historias que contar, algunas veces de desigualdad y resistencia, otras de crisis y esperanza. Te invitamos a un recorrido transformador en el que cada tema será un portal para entenderla como derecho humano, protegerla como patrimonio común, restaurarla como solución climática y garantizarla como legado a las futuras generaciones. Convierte este conocimiento en acción transformadora',
    imageUrl: '/images/introduccion.png', // Reemplaza con la ruta real de la imagen
  },
  {
    title: 'AGUA EN MOVIMIENTO',
    description: "Descubre cómo ha evolucionado el uso del agua para el consumo humano. Además,¡Sigue el recorrido de una gota de agua en todo su ciclo!",
    imageUrl: '/images/modulo1.png', // Reemplaza con la ruta real de la imagen
  },
  {
    title: 'AGUA PARA TODAS LAS PERSONAS',
    description: 'El acceso al agua no es igual para todas las personas, las mujeres y niñas en comunidades rurales son las más afectadas. Impacta en su salud, su educación y sus oportunidades de desarrollo. ¡Explora estas diferencias y aprecia el trabajo de las mujeres en la gestión del agua.',
    imageUrl: '/images/modulo2.png', // Reemplaza con la ruta real de la imagen
  },
  {
    title: 'AGUA LIMPIA',
    description: 'El agua insalubre, el saneamiento inadecuado y la falta de hiegiene desempeñan un papel importante en pa propagación de enfermedades. Debemos proteger nuestras fuentes hídricas, invertir en sistemas de purificación sostenible y educar sobre su uso responsable. Veamos algunas ideas para tener agua limpia.',
  ...
  },
  {
    ...
    description: 'Cada gota cuenta. El tratamiento de aguas residuales es una responsabilidad con nuestro planeta y con nuestros hijos. Al reutilizar y purificar el agua, cuidamos la salud, el medio ambiente y garantizamos este recurso para las proximas generaciones. ¡Actuemos hoy por un mañana sostenible!',
    imageUrl: '/images/modulo6.png', // Reemplaza con la ruta real de la imagen
  },
  {
    title: 'EL AGUA COMO DERECHO UNIVERSAL',
    description: 'El acceso al agua no es un privilegio, es un derecho universal. Garantizar el acceso equitativo, al agua potable y saneamiento es un compromiso con la vida, la dignidad humana, la justicia ambiental y el desarrollo sostennible. Aprende sobre este tema en esta sección.',
    imageUrl: '/images/modulo7.png', // Reemplaza con la ruta real de la imagen
  },
  {
    title: 'EL AGUA COMO UN BIEN COMÚN',
    description: 'El agua nos pertenece a todos y su gestión debe ser responsable y equitativa. Cuidarla y compartirla no es opcional, es un deber colectivo, porque de ella depende nuestra salud, nuestros ecosistemas y el futuro de nuestras comunidades. Descubre aquí la importancia de la acción colectiva.',
    imageUrl: '/images/modulo8.png', // Reemplaza con la ruta real de la imagen
  },
  {
    title: 'EL FUTURO DEL AGUA',
    description: 'Terminamos el recorrido transformándonos en embajadores del agua para protegerla como derecho humano, bien común y solución climática, educando, innovando y actuando desde nuestros espacios. El futuro del agua no se escribe solo, lo contruimos juntos. Aceptamos la responsabilidad y el desafio de ser voz y manos para este legado azul.',
